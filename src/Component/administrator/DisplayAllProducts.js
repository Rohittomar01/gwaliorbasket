...
import { useStyles } from "../../Components_CSS/DisplayAllProductCss";
                            ...
                            <Grid item xs={6}>
                                ...
                                <FormControl>
                                    ...
                                    >
                                        ...
                                        <FormControlLabel value="not_available" control={<Radio />} label="Not_available" checked={status === 'not_available'} />
            ...
            <MaterialTable
                ...
                columns={[
...

                    {
                        ...
                        render: rowData => <div>{rowData.categoryid}</div>
                    },
                    ...
                    {
                        title: 'Trending',
                        render: rowData => <div>{rowData.trending}</div>
                    },
