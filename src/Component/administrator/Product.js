...
import { useStyles } from "../../Components_CSS/ProductCss";
                ...
                <Grid container spacing={2}>
                    <Grid item xs={12} className={classes.rowStyle}>
                        <div style={{ display: 'flex', flexDirection: 'row' }}>
                            <div>
                                <img src="./basketlogo.png" width="40" />
                            </div>
                    ...
                    <Grid item xs={6}>
                        <Button onClick={handleClick} sx={{ background: "black" }} fullWidth variant="contained">Submit</Button>
                    </Grid>
                    <Grid item xs={6}>
                        <Button onClick={clearValue} sx={{ background: "black" }} fullWidth variant="contained">Reset</Button>
                    </Grid>
